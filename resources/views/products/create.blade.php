                    ...
                    <form action="{{route('products.store')}}" method="post" autocomplete="off" enctype="multipart/form-data">
                        ...
                        <div class="form-row">
                            <div class="form-group col-md-6">
                                ...
                                <input type="text" name="name" class="form-control @error('name') is-invalid @enderror" placeholder="ادخل اسم المنتج">
                                @error('name')
                        ...
                        <div class="form-row">
                            <div class="form-group col-md-3">
                                <label>image</label>
                                <input type="file" name="image"  class="form-control img @error('image') is-invalid @enderror">
                                @error('image')
                                <div class="alert alert-danger">{{ $message }}</div>
                                @enderror
                            </div>
                            <div class="col-lg-6">
                                <img src="{{ asset('uploads/product-img/default.jpg') }}" class="img-thumbnail img-preview" width="150" alt="">
                            </div>
                        </div>
                        <div class="form-row">
                        ...
                        <a href="{{ route('products.index') }}" class="btn btn-basic"><i class="fa fa-address-card"></i> الرجوع الى المنتجات<a>
                    </form>
                </div>
            </div>
        </div>
